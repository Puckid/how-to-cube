...
\centering
	...
	{
	\input{./tikz/cubeTop.tex}
	\draw[arrow] ($(p020)+(0.5*\H, 0.5*\H)$) -- ($(p002)+(0.5*\H, 0.5*\H)$);
	\draw[arrow] ($(p002)+(0.5*\H, 0.5*\H)$) -- ($(p022)+(0.5*\H, 0.5*\H)$);
	\draw[arrow] ($(p022)+(0.5*\H, 0.5*\H)$) -- ($(p020)+(0.5*\H, 0.5*\H)$);
	\end{tikzpicture}
	}    	
